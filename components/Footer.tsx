          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex gap-3">
                <a
                  href="https://facebook.com/policyreview"
                  target="_blank"
                ...
                <a
                  href="https://twitter.com/policyreview"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-700 hover:bg-teal-600 transition-all duration-300"
                  aria-label="Twitter"
                ...
                <a
                  href="https://linkedin.com/company/policyreview"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-700 hover:bg-teal-600 transition-all duration-300"
                  aria-label="LinkedIn"
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="#reviews" className="text-gray-300 hover:text-teal-400 transition-colors">
                    Reviews
                  </a>
                </li>
                <li>
        ...
        <div className="border-t border-gray-700 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-gray-400 text-sm">
              ...
              <span className="ml-2">SEBI Registered | IRDAI Compliant</span>
            </div>
            <div className="text-gray-400 text-sm">
